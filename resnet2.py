...
if os.path.exists(checkpoint_save_path + '.index'):
    ...
    # prediction = model.predict(X[0].reshape(-1, 86, 86, 1), tf.float32)
    # print(prediction)
...
history = model.fit(x_train, y_train, batch_size=100, epochs=1, validation_data=(x_test, y_test), validation_freq=1,
                    callbacks=[cp_callback],steps_per_epoch=1)
model.summary()
...
# tf.keras.models.save_model(model="model.h5",filepath="./model/model.h5")
